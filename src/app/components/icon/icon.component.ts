...
@Component({
  ...
  template: `
    <svg
      ...
      [attr.fill]="!stroke ? 'currentColor' : 'none'"
      stroke-width="1.5"
    >
      <ng-container [ngSwitch]="name">
        ...
        <!-- View Boards / Kanban -->
        <ng-container *ngSwitchCase="'view-boards'">
        ...
        <ng-container *ngSwitchCase="'dots-horizontal'">
        ...
        <!-- Device Mobile -->
        <ng-container *ngSwitchCase="'device-mobile'">
